...
ui <- page_navbar(
  ...
  nav_panel("Medal Table", frost_placeholder("Medal Table", "Country rankings with female-only toggle")),
  nav_panel("Events",      frost_placeholder("Events",      "Results by sport and discipline")),
  nav_panel("Athletes",    frost_placeholder("Athletes",    "Female athlete spotlight"))
)
